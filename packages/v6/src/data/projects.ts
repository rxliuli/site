...
export const projects: ProjectMeta[] = [
  ...
  },
  {
    ...
    description:
      'Filter your Twitter/X timeline with customizable rules. Mark, hide, or auto-block tweets based on account properties and tweet content.',
    previewImage: '/images/projects/twitter-filter.jpg',
    type: 'Browser Extension',
    tags: ['Twitter', 'Filter', 'Chrome', 'Firefox', 'Edge', 'Safari'],
    slug: 'twitter-filter',
    featured: true,
    created: '2026-02-24',
    updated: '2026-05-29',
    links: [
      {
        type: 'other',
        name: 'Website',
        url: 'https://store.rxliuli.com/extensions/twitter-filter/',
        icon: 'website',
      },
      {
        type: 'store',
        name: 'Chrome',
        url: 'https://chromewebstore.google.com/detail/feed-filter-for-twitter/ejhilomfbamkbfehkjbhemkpaghpcglj',
        icon: 'chrome',
      },
      {
        type: 'store',
        name: 'Firefox',
        url: 'https://addons.mozilla.org/firefox/addon/twitter-filter/',
        icon: 'firefox',
      },
      {
        type: 'store',
        name: 'Edge',
        url: 'https://microsoftedge.microsoft.com/addons/detail/bidmffpjhlmfnfmnbfhhakpnbikcbehj',
        icon: 'edge',
      },
      {
        type: 'store',
        name: 'Safari',
        url: 'https://apps.apple.com/app/id6759207345',
        icon: 'safari',
      },
    ],
  },
